...
In this model, the binary outcome is whether the unit of observation (individuals within housing units) is Food Secure or not. The variables in the model will try to predict 

# Splitting the data

Now we select a sample from the data inorder to work on the models so that the parent data will remain as it is.
