...
SNAP is the most important factor in food security in our models. In future, we could focus on SNAP alone and make analysis. Also, COVID might have affected to insecurity in families because kids were staying home. But we didn't include this factor in this research.         
KNN performs better than other models for these factors.     
We need to explore the data more in depth and explore previous years’ data to create comparison.    
